...
| 이름 | 역할 |
|------|--------------------------|
| <span style="font-size: 12px;">김진홍</span> | 백엔드 (DB 설계, 회원, 검색기록, 예외처리, 관심사 개발) & 프론트엔드 (오류 수정, 관심사 화면 및 커스텀 마커 렌더링) |
| <span style="font-size: 12px;">고준석</span> | 디자인 (Figma) |
| <span style="font-size: 12px;">김나연</span> | 프론트엔드 (기초 컴포넌트, 블로그 관련 기능 개발) |
| <span style="font-size: 12px;">유민수</span> | 백엔드 (게시글, 좋아요, 스크랩, 조회수 개발) |
| <span style="font-size: 12px;">지상혁</span> | 프론트엔드 (지도, 검색 관련 기능 개발) |
| <span style="font-size: 12px;">최은수</span> | 프론트엔드 (회원가입, 로그인, 초기 화면 개발) |
